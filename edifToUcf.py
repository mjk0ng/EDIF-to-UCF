...
# iostandard mappings get stored here
from iostandard import getMapping
...
print "###  Autogenerated on " + now.strftime("%Y-%b-%d %H:%M") + " by edifToUcf.py"
print "###  Extracting designator " + designator + " from EDIF netlist " + filename + "\n"
